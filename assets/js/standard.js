...
$(document).ready(function (){
    ...
    $(window).scroll(function(){
        ...
        if($(window).scrollTop() >= $("#about-page").offset().top - 50  && $(window).scrollTop() < $("#artwork-page").offset().top - 150 ){
            document.title = 'Tiles by ColumnaeV | About';
        }
        if($(window).scrollTop() >= $("#artwork-page").offset().top - 50  && $(window).scrollTop() < $("#projects-page").offset().top - 150 ){
            document.title = 'Tiles by ColumnaeV | Artwork';
        }
        if($(window).scrollTop() >= $("#projects-page").offset().top - 50  && $(window).scrollTop() < $("#contact-page").offset().top - 150 ){
